...
opt.changrp(1).chan = {'3' '4' '5' '6' '7' '8'};  % can be modified in GUI
opt.changrp(1).ref = {'10' '11'};  % can be modified in GUI
...
opt.changrp(2).chan = {'12'};
opt.changrp(2).ref = {'13'};
