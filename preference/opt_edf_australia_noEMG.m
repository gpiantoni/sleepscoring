...
opt.changrp(1).chan = {'F3' 'F4' 'C3' 'C4' 'P3' 'P4'};  % can be modified in GUI
...
opt.changrp(2).chan = {'Fp1'};
opt.changrp(2).ref = {'Fp2'};
...
opt.changrp(3).chantype = 'ecg';
opt.changrp(3).chan = {'ECG'};
opt.changrp(3).ref = [];
opt.changrp(3).Fhp = 0.3;
opt.changrp(3).Flp = 70;
opt.changrp(3).linecolor = 'g';
opt.changrp(3).scaling = 1;
