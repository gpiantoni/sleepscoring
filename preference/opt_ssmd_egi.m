...
opt.marker.color = {[1 .5 1] [.5 1 1] [1 1 .5]}; % colors, if not enough, they are reused
%-------------------------------------%
...
opt.changrp(2).chan = {'EOG_R_UP'};
opt.changrp(2).ref = {'EOG_L_DOWN'};
...
opt.changrp(4).chan = {'ECG'};
opt.changrp(4).ref = [];
opt.changrp(4).Fhp = 0.3;
opt.changrp(4).Flp = 70;
